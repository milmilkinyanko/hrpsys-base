...
namespace hrp
{
                                                  ...
                                                  const double delay)
  {
    ...
    preview_controller_ptr.reset(new preview_dynamics_filter<extended_preview_control>(dt, cog(2) - rg.get_refzmp_cur()(2), rg.get_refzmp_cur(), gravitational_acceleration));
