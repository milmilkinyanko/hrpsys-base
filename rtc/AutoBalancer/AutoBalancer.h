  ...
  : public RTC::DataFlowComponentBase
{
 ...
 virtual RTC::ReturnCode_t onInitialize();
  ...
  bool setFootStepsForceWithParam(const OpenHRP::AutoBalancerService::FootstepSequence& fs, const OpenHRP::AutoBalancerService::StepForceParamSequence& sfps, CORBA::Long overwrite_fs_idx);
  bool setFootStepsForceWithParam(const OpenHRP::AutoBalancerService::FootstepsSequence& fss, const OpenHRP::AutoBalancerService::StepForceParamsSequence& sfpss, CORBA::Long overwrite_fs_idx);
  void waitFootSteps();
