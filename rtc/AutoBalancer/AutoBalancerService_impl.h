...
public:
  ...
  CORBA::Boolean goPosWheel( CORBA::Double x,  CORBA::Double y,  CORBA::Double th, CORBA::Double w_x,  CORBA::Double rv_max,  CORBA::Double ra_max, CORBA::Double tm_off);
  CORBA::Boolean goWheel( CORBA::Double x,  CORBA::Double rv_max,  CORBA::Double ra_max);
  ...
  CORBA::Boolean setFootStepsWithWheel(const OpenHRP::AutoBalancerService::FootstepsSequence& fss, const OpenHRP::AutoBalancerService::StepParamsSequence& spss, const OpenHRP::AutoBalancerService::WheelParamsSequence& wpss, CORBA::Long overwrite_fs_idx);
  void waitFootSteps();
