...
#define deg2rad(deg) (deg * M_PI / 180)
                                                  ...
                                                  const double delay)
  {
    ...
    preview_controller_ptr = new preview_dynamics_filter<extended_preview_control>(dt, cog(2) - rg.get_refzmp_cur()(2), rg.get_refzmp_cur(), preview_f, gravitational_acceleration);
  ...
  bool gait_generator::proc_one_tick (const hrp::Vector3& diff_cp)
  {
    solved = false;
    /* update refzmp */
