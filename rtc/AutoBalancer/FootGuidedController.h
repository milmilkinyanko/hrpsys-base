...
{
private:
  void calc_u(const std::size_t N, const double ref_dcm, const double ref_zmp, const bool is_double, const double start_ref_zmp, const double final_ref_zmp, const size_t double_N);
  void truncate_u();
  void calc_x_k();
protected:
...
public:
  ...
  ~foot_guided_control_base() {};
  // update function
  void update_control(double& zmp, const std::size_t N, const double ref_dcm, const double ref_zmp, const bool is_double, const double start_ref_zmp, const double final_ref_zmp, const size_t double_N);
...
public:
  ...
  // update function
  void update_control(hrp::Vector3& p_ret, const std::size_t N, const hrp::Vector3& ref_dcm, const hrp::Vector3& ref_zmp, const bool is_double, const hrp::Vector3& start_ref_zmp, const hrp::Vector3& final_ref_zmp, const std::size_t double_N)
  {
    for (size_t i = 0; i < dim; i++)
      controllers[i].update_control(p_ret[i], N, ref_dcm[i], ref_zmp[i], is_double, start_ref_zmp[i], final_ref_zmp[i], double_N);
  }
