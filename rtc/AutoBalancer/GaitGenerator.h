...
namespace rats
{
  ...
  private:
    ...
    bool use_stride_limitation, is_emergency_walking, modify_footsteps, modify_refzmp;
  ...
  public:
    ...
    gait_generator (double _dt,
        ...
        use_inside_step_limitation(true), use_stride_limitation(false), is_emergency_walking(false), modify_footsteps(false), modify_refzmp(false), default_stride_limitation_type(SQUARE),
    ...
    void set_footstep_modification_gain (const double _footstep_modification_gain[2]) {
    ...
    void set_modify_refzmp (const bool _modify_refzmp) { modify_refzmp = _modify_refzmp; };
    ...
    bool get_modify_refzmp () const { return modify_refzmp; };
