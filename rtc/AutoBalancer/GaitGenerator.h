...
namespace rats
{
  ...
  private:
    ...
    bool solved;
    double leg_margin[4], stride_limitation_for_circle_type[4], overwritable_stride_limitation[4], footstep_modification_gain, cp_check_margin[2], margin_time_ratio;
    bool use_stride_limitation, act_contact_states[4], is_emergency_walking[2], modify_footsteps;
