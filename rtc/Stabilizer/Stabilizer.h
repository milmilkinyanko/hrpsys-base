  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  RTC::TimedPoint3D m_absRefCOG;
  RTC::TimedPoint3D m_absRefCOGVel;
  ...
  RTC::TimedBooleanSeq m_emergencySignalStep;
  ...
  RTC::OutPort<RTC::TimedPoint3D> m_absRefCOGOut;
  RTC::OutPort<RTC::TimedPoint3D> m_absRefCOGVelOut;
  ...
  RTC::OutPort<RTC::TimedBooleanSeq> m_emergencySignalStepOut;
  // for debug output
 ...
 private:
  ...
  bool is_legged_robot, on_ground, is_emergency, is_emergency_step[4], is_emergency_while_walking, is_seq_interpolating, reset_emergency_flag, eefm_use_force_difference_control, eefm_use_swing_damping, initial_cp_too_large_error, use_limb_stretch_avoidance;
  ...
  std::vector<double> cp_check_margin, cp_check_thre_step, tilt_margin;
