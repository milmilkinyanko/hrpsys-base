  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  RTC::TimedDoubleSeq m_tmpCogValues;
  ...
  RTC::OutPort<RTC::TimedDoubleSeq> m_tmpCogValuesOut;
 ...
 private:
  ...
  boost::shared_ptr<FirstOrderLowPassFilter<hrp::Vector2> > act_zmp_filter;
